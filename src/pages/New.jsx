...
const New = ()=>{
    ...
    return(
        <div  className='menpage'>
            ...
            {showFilter? <FilterPrduct page ="New" DataProducts ={FilterProducts}/> : null}
            <MainProducts page="Neww" statusFilter={showFilter} showFilter={changeShowFilter} DataProducts = {[...presentProducts]}/>
            </div>
